...
class DataArguments:
    ...
    temporal_reasoning_sample_rate: list[float] = field(default_factory=lambda: [0.0])
    multihop_qa_sample_rate: list[float] = field(default_factory=lambda: [0.0])
